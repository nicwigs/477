...
class EnigmaView extends View
{
    public function check_name(){
        if($this->system->check() != System::VALID){
            header("location: ./index.php");
        }
    }
    public function present_rotors(){
...
<figure class="enigma"><img src="images/enigma.png" alt="Enigma Simulation"></figure><div class="rotors">
HTML;
        $html .= $this->present_rotors();
        $html .= '</div>';
        ...
        foreach($cells as $key => $cell){
            ...
            $pressed = ''; //$cell->isPressed() ? 'pressed ' : '';  REMOVED FOR JSON, WOULD KEEP BUTTON RED IF GO TO SETTINGS THEN COME BACK
