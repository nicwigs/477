...
class System
{
    ...
    public function extraCode($code){
        // Then, assuming the three letters are in $code, we do:
        $c1 = $this->enigma->pressed(substr($code, 0, 1));
        $c2 = $this->enigma->pressed(substr($code, 1, 1));
        $c3 = $this->enigma->pressed(substr($code, 2, 1));

        $this->enigma->setRotorSetting(1, $c1);
        $this->enigma->setRotorSetting(2, $c2);
        $this->enigma->setRotorSetting(3, $c3);
    }
